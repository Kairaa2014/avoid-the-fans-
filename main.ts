...
let Kairaa = sprites.create(assets.image`rockstar`, SpriteKind.Player)
controller.moveSprite(Kairaa)
tiles.placeOnRandomTile(Kairaa, assets.tile`stage`)
scene.cameraFollowSprite(Kairaa)
